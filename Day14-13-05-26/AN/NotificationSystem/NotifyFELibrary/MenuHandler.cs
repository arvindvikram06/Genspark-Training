    ...
    public class MenuHandler
    {
        ...
        private void UserMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("3.GetUserById");
        ...
        private void NotificationMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("4. Get Notification By ID");
                Console.WriteLine("5. Update Notification Message");
                Console.WriteLine("6. Unsend Notification");
                ...
                switch (choice)
                {
                    ...
                    case "3":
                         _userInteraction.ListAllNotification();
                          break;
                    case "4":
                        _userInteraction.GetNotificationById();
                        break;
                    case "5":
                        _userInteraction.UpdateNotification();
                        break;
                    case "6":
                        _userInteraction.DeleteNotification();
                        break;
                    case "7": 
                        return;
                    default: 
